...
const projects = [
  {
    ...
    description: "A fully responsive e-commerce platform with secure user authentication, product management, shopping cart, and seamless checkout integration.",
    image: "/ecom.png?height=600&width=800",
  ...
  },
  {
    ...
    description: "A comprehensive system for managing student records, attendance, grades, and schedules with user authentication and role-based access control.",
    image: "/sms.png?height=600&width=800",
  ...
  },
  {
    ...
    description: "A comprehensive platform that evaluates user skills through automated assessments, providing insights and personalized recommendations for improvement",
    image: "/skill.png?height=600&width=800",
